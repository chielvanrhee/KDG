...
public class TestContact {
    public static void main(String[] args) {
        ...
        System.out.println(vastFoutBegin.isGeldigNummer() + " " + vastFoutAantal.isGeldigNummer() + " " + gsmFoutBegin.isGeldigNummer() + " " + gsmFoutAantal.isGeldigNummer());
...
// verder gaan door de toString methode te  overriden, daardoor zou de hele opdracht moeten lukken
